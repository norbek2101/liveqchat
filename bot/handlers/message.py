...
#     def go_to_main(message: types.Message, user: BotUser, bot: TeleBot = _):
#         user.set_step()
#         bot.send_message(
#             message.chat.id,
#             user.text.main_text,
...
#     @auth
#     def change_language_handler(message: types.Message, user: BotUser, bot: TeleBot = _):
...
#     @auth
#     def developer_handler(message: types.Message, user: BotUser, bot: TeleBot = _):
#         if user.check_step(STEP.MAIN):
#             bot.send_message(
#                 message.chat.id,
#                 "👨🏻‍💻 @anvarjamgirov",
...
#     @auth
#     def post_handler(message: types.Message, user: BotUser, bot: TeleBot = _):
#         if user.is_admin:
...
#     @auth
#     def back_handler(message: types.Message, user: BotUser, bot: TeleBot = _):
#         go_to_main(message, user)

#     @_.message_handler(func=lambda message: True)
#     @auth
#     def all_message_handler(message: types.Message, user: BotUser, bot: TeleBot = _):
...
#     @auth
#     def voice_handler(message: types.Message, user: BotUser, bot: TeleBot = _):
#         if user.is_admin:
...
#     @auth
#     def video_handler(message: types.Message, user: BotUser, bot: TeleBot = _):
#         if user.is_admin:
#             if user.check_step(STEP.GETTING_POST_MESSAGE):
#                 user.set_step()
#                 bot.reply_to(
