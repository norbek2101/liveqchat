...
urlpatterns = [
                ...
                path('daily-message/<int:operator_id>/', DailyReport.as_view(), name = 'daily-message' ),
                path('weekly-message/<int:operator_id>/', WeeklyReport.as_view(), name = 'weekly-message' ),
                path('monthly-message/<int:operator_id>/', MonthlyReport.as_view(), name = 'monthly-message' ),
                path('dashboard-daily/', DashBoardDaily.as_view(), name = 'dashboard-daily'),
                path('dashboard-weekly/', DashBoardWeekly.as_view(), name = 'dashboard-weekly'),
                path('dashboard-monthly/', DashBoardMonthly.as_view(), name = 'dashboard-monthly'),
